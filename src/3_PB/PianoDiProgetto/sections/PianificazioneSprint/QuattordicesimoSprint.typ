...
- Proseguire la stesura del _Piano di Progetto_:
    - Aggiornare pianificazione e preventivo pertinenti agli #glossary[sprint] 14 e 15 inserire il consuntivo pertinente allo #glossary[sprint] 13;
...
- Terminare la stesura della _Specifica Tecnica_:
    ...
    - Aggiornare il soddisfacimento dei requisiti nella sezione dedicata al tracciamento;
