...
== Glossario
Al fine di evitare possibili ambiguità relative al linguaggio utilizzato nei documenti, viene fornito il _Glossario v2.0_, nel quale sono presenti tutte le definizioni di termini aventi uno specifico significato che vuole essere disambiguato. Tali termini, sono scritti in _corsivo_ e marcati con una #sub("G") a pedice.
...
- Slide dell'insegnamento di Ingegneria del Software:
  - Modelli di sviluppo del software:
    - _ https://www.math.unipd.it/~tullio/IS-1/2023/Dispense/T3.pdf _ (22/11/2023)
  - Gestione di progetto:
    - _ https://www.math.unipd.it/~tullio/IS-1/2023/Dispense/T4.pdf _ (29/12/2023)
  - Analisi dei requisiti:
    - _ https://www.math.unipd.it/~tullio/IS-1/2023/Dispense/T5.pdf _ (18/01/2024)
...
- *Seconda revisione (#glossary[PB] - Product Baseline):* 04 Aprile 2024.