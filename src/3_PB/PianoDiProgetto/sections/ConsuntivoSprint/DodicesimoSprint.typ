...
Nella retrospettiva è stato evidenziato il rispetto del totale delle ore preventivate per questo #glossary[sprint], con una differenza di soli 30 minuti tra il preventivo e il consuntivo, il che costituisce un tasso di errore dell'1% circa. È notevole come il team sia riuscito a gestire senza particolari intoppi un regime sostenuto di circa 60 ore produttive settimanali, dimostrando così impegno e coerenza nel rispettare le scadenze prefissate per arrivare il prima possibile alla seconda revisione #glossary[PB].
...
Per quanto riguarda l'attività di codifica, si può affermare che, con l'ultima implementazione dei sensori urbanistici rimanenti, la parte del prodotto software relativa alla simulazione dei dati potrebbe essere considerata conclusa. Questo traguardo è stato raggiunto in breve tempo grazie ad una buona distribuzione del lavoro a carico dei Programmatori; infatti, ciascun membro del team si è dedicato allo sviluppo di uno o due simulatori diversi nel corso degli ultimi due #glossary[sprint] e, in tal modo, il team è riuscito a realizzare gli 11 sensori previsti dall'_Analisi dei Requisiti_ e a coniugarli con la nuova #glossary[architettura].
