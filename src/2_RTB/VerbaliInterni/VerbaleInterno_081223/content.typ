...
Per quanto riguarda l'_Analisi dei Requisiti_, è stato stabilito il processo da seguire. Per prima cosa si prosegue con il miglioramento dei casi d'uso, con successiva verifica della qualità tramite uno sportello con il professor Cardin, prenotato al termine del rifacimento dei casi d'uso. Se il professore approvasse quanto realizzato, si procederà con la stesura dei requisiti, in caso contrario si tornerà alla correzione dei casi d'uso.
