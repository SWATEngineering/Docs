...
Riccardo Toniolo, nel ruolo di responsabile, si occupa della redazione e della presentazione del prossimo (Diario Di Bordo) in data 13/11/2023.
...
La responsabilità della modifica della sezione Versionamento nelle NdP (Note di Progetto) è stata assegnata a Matteo Rango.
...
La Repository _Docs_ è stata strutturata in modo da mantenere separato il codice _Typst_ per la produzione dei documenti (_src_) e i documenti pdf prodotti, raccolti nelle cartelle che corrispondono alle milestone. Di seguito viene riportato un esempio della struttura.
