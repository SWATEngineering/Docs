...
Tuttavia, nel caso si decida in futuro di coinvolgere più di un Verificatore, la politica per assegnare loro le _issue_ da revisionare all'interno dell'ITS è la seguente: il Verificatore seleziona autonomamente la _issue_ con la priorità maggiore all'interno della #glossary("corsia") _Ready to Review_ sulla Kanban Board in utilizzo su Github e procede con la revisione.
...
Il team si sta orientando verso un approccio collaborativo dove, durante lo sviluppo del codice, due o più Programmatori lavorano insieme, anche se non in un'esclusiva modalità di _pair-programming_ su una singola _issue_. Questo approccio mira a favorire lo scambio di consigli e la collaborazione diretta, ma non implica necessariamente un impegno costante su una singola attività.
