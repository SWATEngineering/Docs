...
Per questa motivazione, verrà incluso il _Context Switch_ all'interno dell'analisi dei rischi del piano di progetto. 

Le soluzioni proposte, per ovviare al problema,sono le seguenti:

      - La persona che ha precedentemente occupato quel ruolo specifico, offre supporto al membro del team che ha assunto ora quella posizione, facilitandone la transizione e assistendo il responsabile o l'amministratore nella creazione delle _issue_ per il prossimo sprint;
