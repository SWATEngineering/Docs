...
Il team ha successivamente discusso di come sia più appropriato riportare ed evidenziare gli effetti del nuovo budget preventivato (nuovo BAC o "Budget At Completion") all'interno del _Piano di Qualifica v1.0_, e ha esplorato due alternative principali: applicare il nuovo BAC solo agli #glossary[sprint] successivi alla revisione #glossary[RTB], oppure applicarlo a partire dallo #glossary[sprint] 7 (#glossary[sprint] all'inizio del quale è stato creato il nuovo preventivo) in poi. Il team ha optato per la seconda alternativa, volendo sostanzialmente mostrare l'adattamento del team all'andamento del progetto delineato nei grafici fino al settimo #glossary[sprint] e valutare se i valori accettabili stabiliti in partenza per le metriche oggetto di misurazione finora siano adeguati o meno rispetto al nuovo BAC. 
