...
Il team, constatando che la pianificazione e i preventivi redatti per ciascun sprint fino alla conclusione del progetto (ovvero la terza revisione CA) non rispecchiano più l'attuale progresso del lavoro, ha deciso di eliminare la pianificazione a lungo termine dal _Piano di Progetto v1.0_ e di sostituirla con una pianificazione a breve termine (2 sprint in avanti). Le ragioni principali che hanno motivato questa scelta sono le seguenti:
  - Pianificazione e relativi preventivi a lungo termine sono stati realizzati al termine del secondo sprint quando il team non aveva ancora avuto tempo a sufficienza per poter fare una stima accurata della propria velocità di progressione e della portata della frazione di progetto da portare a termine in vista della prima revisione RTB. Di conseguenza, la pianificazione risultava poco flessibile e del tutto svincolata dalla realtà, fornendo inoltre una stima poco precisa della distribuzione delle ore complessive dedicate alle 3 milestoneprincipali o revisioni;
