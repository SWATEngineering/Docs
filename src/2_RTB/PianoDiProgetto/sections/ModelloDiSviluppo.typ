...
=== Eventi
- *Sprint Planning*: il team identifica gli item del #glossary("Product Backlog") che può impegnarsi a completare, tenendo conto della capacità e delle risorse disponibili. Questi item diventano lo #glossary("Sprint Backlog"), che è una lista collaborativamente creata da tutto il team e include le _User Story_ o gli item di lavoro selezionati, suddivisi in attività più specifiche o _issue_. Inoltre, il team si concentra sulla stima delle _issue_, determinando quanto tempo e sforzo ciascuna richiederà;
...
- *Sprint Review*: incontro chiave nel framework Scrum che si tiene alla fine di ogni Sprint. In questa cerimonia ci si focalizza sull'esame del lavoro completato e sulla raccolta dei vari feedback.  La presenza attiva della Proponente è di importanza cruciale in questo contesto, poiché contribuisce in modo significativo a garantire una comprensione accurata degli obiettivi raggiunti e a facilitare una comunicazione diretta e fruttuosa con il team,consentendo un allineamento più diretto con le aspettative del Cliente.
- *Sprint Retrospective*: incontro chiave nel framework Scrum che avviene alla fine di ogni Sprint. È un momento dedicato al team per riflettere sullo sprint appena concluso e identificare possibili miglioramenti. Durante questa riunione, i membri del team esaminano ciò che è andato bene, ciò che è andato meno bene e le possibili aree di miglioramento.
