...
*Obiettivi dello #glossary[sprint]*: 
  ...
  - Proseguire la stesura del _Piano di Progetto_:
    ...
    - Inserimento *Pianificazione* dettagliata degli #glossary[sprint] 1 e 2 e bozza di pianificazione a lungo termine per valutare tutte le macro-attività necessarie per lo svolgimento del progetto fino alla terza revisione CA (#glossary[sprint] 16);
    - Inserimento *Preventivo* dettagliato degli #glossary[sprint] 1 e 2 con grafici di supporto visivo e bozza di preventivo a lungo termine per effettuare una stima di una possibile suddivisione delle ore totali e del budget a disposizione per ciascuno print fino alla terza revisione CA (#glossary[sprint] 16);
