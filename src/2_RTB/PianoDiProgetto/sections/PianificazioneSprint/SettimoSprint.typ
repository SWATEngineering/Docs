...
*Obiettivi dello #glossary[sprint]*: 
  ...
  - Proseguire la revisione in stile #glossary["walkthrough"] delle _Norme di Progetto_;
  ...
  - Inizio revisione in stile #glossary["walkthrough"] del _Piano di Qualifica_:
    - Inserimento nuovo BAC (Budget At Completion) ed evidenziazione del cambiamento avvenuto nel corso dello #glossary[sprint] 7 all'interno dei grafici.
