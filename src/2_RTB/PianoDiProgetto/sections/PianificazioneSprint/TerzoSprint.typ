...
*Obiettivi dello #glossary[sprint]*: 
  ...
  - Proseguire la stesura delle _Norme di Progetto_, ponendo particolare attenzione su: spiegazione dei diagrammi #glossary[UML] dei casi d'uso utilizzati nell'_Analisi dei Requisiti_ e la descrizione dettagliata del significato e delle formule pertinenti alle metriche per la qualità;
  - Proseguire la stesura del _Piano di Progetto_, con l'aggiornamento di pianificazione e preventivo pertinenti allo #glossary[sprint] 3 e l'inserimento del consuntivo pertinente allo #glossary[sprint] 2;
  - Proseguire la stesura dell'_Analisi dei Requisiti_:
    ...
    - Inserimento dei diagrammi #glossary[UML] realizzati precedentemente;
