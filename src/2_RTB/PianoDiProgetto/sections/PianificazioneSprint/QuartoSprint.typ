...
*Obiettivi dello #glossary[sprint]*: 
  ...
  - Proseguire la stesura del _Piano di Qualifica_:
    - Inizio stesura del cruscotto delle metriche con valutazione delle metriche sui processi primari (fornitura) e di supporto (documentazione) rispetto agli #glossary[sprint] 1 e 2 e inclusione di grafici di confronto tra metriche per ricavare informazioni utili sull'andamento effettivo del progetto;
