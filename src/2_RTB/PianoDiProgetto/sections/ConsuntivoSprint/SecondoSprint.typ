...
Il consuntivo delinea come il numero di ore preventivate sia ancora notevolmente inferiore rispetto a quelle effettivamente utilizzate, in questo caso non a causa di una pianificazione irrealistica (dato che le ore preventivate sono simili in numero a quelle effettive dello sprint precedente), ma principalmente a causa di un imprevisto pertinente all'_Analisi dei Requisiti_; infatti, dal consuntivo emerge una notevole sottostima del tempo richiesto al ruolo di Analista. Ciò è dovuto al fatto che il team, dopo il colloquio con il professor Cardin e una discussione con la Proponente, si è focalizzato sulla ristrutturazione della maggior parte del documento, il che ha richiesto un notevole sforzo aggiuntivo. 
Inoltre, dato che si era previsto che i componenti assumessero più di un ruolo nel corso di questo sprint, i ruoli sono stati nuovamente ruotati a metà sprint; l'emergere del rischio RC5 o Context Switch si è rivelato di difficile gestione a metà sprint senza che vi fosse un'occasione di stabilire con precisione il progresso attuale del team rispetto alla prossima milestone. In particolare, il dover portare avanti attività realizzate solo in parte non si è rivelata una scelta efficiente. Per questo ed altri motivi, si è deciso di adottare sprint di una settimana e, di conseguenza, preventivare un quantitativo più piccolo di ore in futuro (pur mantenendo la possibilità per i membri di assumere più di un ruolo). 
