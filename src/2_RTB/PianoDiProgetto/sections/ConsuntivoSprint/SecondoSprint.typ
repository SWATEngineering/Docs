...
Il consuntivo relativo al corrente sprint evidenzia significative disparità rispetto al preventivo, soprattutto in merito alla distribuzione dei ruoli. Tale deviazione è imputabile al cambiamento dei ruoli assegnati, avvenuto a metà dello sprint, circostanza che non prevista durante la fase di pianificazione iniziale. Inoltre, va sottolineato che la conclusione delle attività pendenti dallo sprint precedente ha determinato brevi periodi di tempo in cui i membri del team hanno mantenuto i ruoli assegnati nella fase precedente. Pur constatando un aumento complessivo delle ore e dei costi, è da notare che tali incrementi non risultano eccessivi. Emergono chiaramente, in particolare, una sovrastima delle ore necessarie per il ruolo di programmatore e una sottostima per il ruolo di analista. Tali considerazioni saranno utilizzate come base per ottimizzare la pianificazione degli sprint futuri.