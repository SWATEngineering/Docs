...
Visto il periodo di interesse, non ci sorprende che i rischi emersi siano: RC1 o "Mancata organizzazione della comunicazione interna" e RP4 o "Impegni universitari". Per quanto riguarda RC1, non è stato gestito in maniera efficacie, in quanto sono venute meno le varie misure preventive atte ad evitarne la manifestazione e limitarne gli effetti:
  ...
  - L'Ordine del giorno non è stato realizzato in quanto non è stato svolto un incontro interno al termine dello #glossary[sprint] vista la mancanza di disponibilità di vari componenti del team negli ultimi giorni dell'anno;
    - Gli #glossary[Stand-up meeting] si sono decisamente rivelati una delle misure efficaci nel prevenire un disallineamento delle priorità dei componenti, tuttavia non è stato possibile effettuarli nel periodo appena trascorso vista l'interruzione delle lezioni e la conseguente mancata possibilità di poter interagire dal vivo.

In altre parole, non è stata l'inadeguatezza delle misure preventive a determinare la manifestazione del rischio quanto la loro mancata applicazione. In ogni caso, si è discusso di misure ulteriori da predisporre nei casi in cui non ci sia sufficiente comunicazione e collaborazione all'interno del team, quali #glossary[Stand-up meeting] giornalieri, anche da remoto ed eventuali meeting di emergenza, con la possibilità di abbassare il quorum  a 3/6 persone in caso di necessità.
