...
Il consuntivo si mantiene relativamente simile al preventivo (delineando anzi, come le ore effettive siano a ribasso rispetto a quelle preventivate per la prima volta) ma è da notare che le ore da Amministratore sono ancora una volta in quantità maggiore rispetto a quanto preventivato, mentre vale il contrario per le ore da Verificatore. La spiegazione sta nel fatto che il team aveva inizialmente pensato di poter preparare tutto il materiale necessario e sostenere la prima revisione RTB entro la fine di Dicembre e si era preparato, di conseguenza, a impiegare più risorse per la revisione di alcuni documenti. Tuttavia, sono risultate necessarie più ore da Amministratore di quanto pensato in partenza visto che i componenti che ricoprono tale ruolo sono impegnati nella stesura sia delle _Norme di Progetto_ che del _Piano di Qualifica_, ed entrambi non erano vicini ad essere ultimati. Per quanto riguarda il _Piano di Qualifica_, inoltre, non ci si aspettava di incorrere in difficoltà nel calcolo delle percentuali di lavoro preventivato e svolto, necessarie per la valutazione di PV ed EV, per cui si è incorsi in un breve momento di stallo. 

Il team ha portato a termine tutti gli obiettivi prefissati eccetto la stesura completa del cruscotto delle metriche all'interno del _Piano di Qualifica_, il quale è stato sviluppato includendo la valutazione delle metriche prescelte fino allo #glossary[sprint] 2, ma non oltre (nell'attesa di ricevere l'approvazione del metodo utilizzato per calcolare PV ed EV da parte del team). L'unico rischio emergente è dunque stato RP3 o "Variazioni nei tempi e costi del progetto", con riferimento in particolare allo spostamento della data prevista per svolgere la prima revisione RTB. In questo senso, si è preso atto che la pianificazione a lungo termine realizzata inizialmente non risultava flessibile a sufficienza da poter accomodare eventuali imprevisti o variazioni e di fatto contraddice la prima misura preventiva che il team si era proposto di utilizzare. In secondo luogo, avendo cominciato la stesura del _Piano di Qualifica_ solo recentemente, il cruscotto delle metriche non è ancora avanzato e dettagliato al punto da facilitare la gestione delle risorse nel progetto. In conclusione, sicuramente si renderà necessario rivalutare la pianificazione utilizzata finora e investire più risorse nella stesura del _Piano di Qualifica_.