...
#table(
  ...
  [Simone Caregnato],[-],[3],[-],[-],[2],[-],[5],
  [Riccardo Alberto Costantin],[3],[-],[-],[2],[1],[-],[6],
...
#figure(
  image("../../assets/AreogrammiPartizioneOre/Preventivato/AreogrammaOreOttavoSprint.png", width: 75%),
  caption: [Areogramma della partizione delle ore per ruolo nel ottavo sprint.],
) 

#figure(
  image("../../assets/IstogrammiOreMembro/Preventivate/IstogrammaOttavoSprint.png", width: 75%),
  caption: [Isotgramma delle ore per membro nell'ottavo sprint.],
)
...
#figure(
  image("../../assets/AreogrammiPartizioneCosti/Preventivato/AreogrammaCostiOttavoSprint.png", width: 75%),
  caption: [Areogramma del budget speso e rimanente preventivato per il ottavo sprint.],
) 

#figure(
  image("../../assets/AreogrammiTotaliOre/Preventive/AreogrammaTotaleOttavoSprint.png", width: 75%),
  caption: [Areogramma delle ore totali e rimanenti nell'ottavo sprint.],
)