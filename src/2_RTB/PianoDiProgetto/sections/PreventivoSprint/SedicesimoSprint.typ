...
#figure(
  image("../../assets/AreogrammiPartizioneOre/Preventivato/AreogrammaOreSedicesimoSprint.png", width: 75%),
  caption: [Areogramma della partizione delle ore per ruolo nel sedicesimo sprint.],
) 

#figure(
  image("../../assets/IstogrammiOreMembro/Preventivate/IstogrammaSedicesimoSprint.png", width: 75%),
  caption: [Isotgramma delle ore per membro nel sedicesimo sprint.],
)
...
#figure(
  image("../../assets/AreogrammiPartizioneCosti/Preventivato/AreogrammaCostiSedicesimoSprint.png", width: 75%),
  caption: [Areogramma del budget speso e rimanente preventivato per il sedicesimo sprint.],
) 

#figure(
  image("../../assets/AreogrammiTotaliOre/Preventive/AreogrammaTotaleSedicesimoSprint.png", width: 75%),
  caption: [Areogramma delle ore totali e rimanenti nel sedicesimo sprint.],
)