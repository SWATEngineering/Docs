...
#table(
  ...
  [Riccardo Alberto Costantin],[1],[-],[-],[-],[-],[4],[5],
  [Giacomo D'Ovidio],[],[-],[-],[-],[-],[6],[6],
  [Nancy Kalaj],[-],[-],[-],[-],[6],[-],[6],
  [Matteo Rango],[-],[-],[-],[-],[6],[-],[6],
  [Riccardo Toniolo],[-],[3],[-],[-],[2],[-],[5],
...
#figure(
  image("../../assets/AreogrammiPartizioneOre/Preventivato/AreogrammaOreQuindicesimoSprint.png", width: 75%),
  caption: [Areogramma della partizione delle ore per ruolo nel quindicesimo sprint.],
) 

#figure(
  image("../../assets/IstogrammiOreMembro/Preventivate/IstogrammaQuindicesimoSprint.png", width: 75%),
  caption: [Isotgramma delle ore per membro nel quindicesimo sprint.],
)
...
#figure(
  image("../../assets/AreogrammiPartizioneCosti/Preventivato/AreogrammaCostiQuindicesimoSprint.png", width: 75%),
  caption: [Areogramma del budget speso e rimanente preventivato per il quindicesimo sprint.],
)

#figure(
  image("../../assets/AreogrammiTotaliOre/Preventive/AreogrammaTotaleQuindicesimoSprint.png", width: 75%),
  caption: [Areogramma delle ore totali e rimanenti nel quindicesimo sprint.],
)