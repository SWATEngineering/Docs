...
Per quanto concerne il codice gli obiettiviche si erano concordati erano l'*Implementazione di uno script di simulazione* e la *Creazione di un Ambiente Containerizzato*. 
...
La Proponente ha accettato la proposta e l'incontro e' stato fissato per mercoledi' 29 novembre.
...
Una volta onfermata l'intenzione del team di effettuare la prima revisione entro il 18 dicembre, è stato invece deciso di accorpare nello _Sprint Backlog_ anche la componente di visualizzazione che era stata inizialmente pianificata come parte dello sprint successivo. In altre parole, il team avrà realizzato una prima versione completa del Proof of Concept entro la fine dello sprint attuale, programmata per il 7 Dicembre.
...
- *Formato JSON o divisione in colonne:* Viene consigliato di indagare sul comportamento di ClickHouse e effettuare una scelta sulla base delle operazioni che si intendono effettuare; 
