...
La Proponente ha infine fornito alcuni consigli per affrontare al meglio la prima revisione RTB:
  ...
  - Rendere la #glossary[dashboard] più dinamica restringendo l'intervallo temporale di visualizzazione dei dati: in particolare, è stato suggerito di impostare un intervallo di tempo ridotto all'inizio della presentazione per mostrare l'andamento dei dati in ingresso e di allargarlo in seguito;
